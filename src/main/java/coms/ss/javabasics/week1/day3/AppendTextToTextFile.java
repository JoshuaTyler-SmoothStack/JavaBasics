...
public class AppendTextToTextFile {
  ...
  public static void main(String[] args) {
    if(args == null || args.length < 1) {
      System.err.println("Invalid Args - please include text to be appended to 'Output.txt'");
      return;
    }

    String path = System.getProperty("user.dir").replace("\\", "/")+"/src/com/ss/week1/day3/Output.txt";
